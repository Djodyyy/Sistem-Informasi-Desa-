...
require_once 'functions/function_informasi_publik.php';

$dataInformasi = getAllInformasiPublik();
?>
...
<head>
  ...
  <title>Informasi Publik - Desa Cibening</title>
...
<body class="index-page">
  <main class="main">
    ...
    <section id="informasipublik" class="section">
      <div class="container" data-aos="fade-up">
        ...
        <div class="table-responsive">
          <table id="tabelInformasiPublik" class="table table-striped table-bordered">
            ...
            <tbody>
              <?php if (!empty($dataInformasi)): ?>
                <?php $no = 1; foreach ($dataInformasi as $row): ?>
                  <tr>
                    ...
                    <td class="text-center">
                      <?php if (!empty($row['file_path'])): ?>
                        <a href="uploads/<?= htmlspecialchars($row['file_path']) ?>" class="btn btn-sm btn-download" target="_blank">
              ...
              <?php else: ?>
                <tr>
                  <td colspan="5" class="text-center text-danger">Belum ada data informasi publik.</td>
                </tr>
              <?php endif; ?>
            </tbody>
          </table>
    ...
    <script>
      $(document).ready(function () {
        $('#tabelInformasiPublik').DataTable({
          responsive: true,
          language: {
