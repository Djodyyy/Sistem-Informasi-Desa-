!(function (i) {
    ...
    (t.prototype.initMenu = function () {
      ...
      this._reset(),
        ...
        i('.side-nav').length &&
          ...
          i(".side-nav li [data-bs-toggle='collapse']").on('click', function (
            t,
          ) {
            return !1
          }),
            ...
            this.href == o &&
              ...
              'sidebar-menu' !==
                (t = i(this)
                  ...
                  .parent()
                  .parent()
                  .parent()).attr('id') && t.addClass('show'),
              i(this)
                .parent()
                .parent()
                .parent()
      ...
      a.forEach(function (a) {
        a.addEventListener('click', function (t) {
          ...
          a.parentElement.classList.contains('nav-item') ||
            ((o = !0),
            (e = a.parentElement.parentElement.parentElement.querySelector(
              '.nav-link',
            )),
  ...
  (function (a) {
    ...
    ;(t.prototype._selectOptionsFromConfig = function () {
      ...
      if (t) {
        switch (
          (a('.end-bar input[type=checkbox]').prop('checked', !1),
          t.sideBarTheme)
        ) {
          case 'default':
        ...
        a(document).on('click', '.end-bar-toggle', function () {
          ...
          a(document).on('click', 'body', function (t) {
            0 < a(t.target).closest('.end-bar-toggle, .end-bar').length ||
              ...
              (a('body').removeClass('end-bar-enabled'),
        ...
        a(document).ready(function (t) {
          document.querySelectorAll('pre span.escape').forEach(function (t, e) {
            for (
              ...
              o[i].trim() && (a = Math.min(o[i].search(/\S/), a))
            for (var n = [], i = 0; i < o.length; i++)
              n.push(o[i].replace(new RegExp('^ {' + a + '}', 'g'), ''))
            t.innerText = n.join('\n')
          }),
  ...
  (function (a) {
    ...
    ;(t.prototype.activateDefaultSidebarTheme = function () {
      ...
      (t.prototype.init = function () {
        ...
        document.getElementById('light-style').href.includes('rtl.min.css') &&
          (document.getElementsByTagName('html')[0].dir = 'rtl'),
          document.getElementById('dark-style').href.includes('rtl.min.css') &&
            (document.getElementsByTagName('html')[0].dir = 'rtl')
      }),
      (a.App = new t()),
      (a.App.Constructor = t)
